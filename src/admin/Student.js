...
const Student = () => {
  ...
  const [ob1, setob1] = useState({name:"",email:"",password:"",courses:"",phone:""})
  const [ob2, setob2] = useState({id:0, name:"",email:"",password:"",courses:"",phone:""})
  ...
  return (
    <div className='wrapper'>
        ...
        <datalist id='coursesList'>
          {b.map(x=><option value={x.name}>{x.name}/{x.price}</option>)}
        </datalist>
        <div className='form'>
          ...
          <input list='coursesList' name='courses' placeholder='courses' value={ob1.courses} onChange={handleChnage}/>
       ...
       {ob2?.id > 0 &&
        ...
        <div className='form'>
          ...
          <input list='coursesList' name='courses' value={ob2.courses} onChange={handleChnage1}/>
          <input name='phone' value={ob2.phone} onChange={handleChnage1}/>
          <button onClick={update}>Update</button>
        </div>
       }
        <h2>Total student : {a.length}</h2>
